...
from synthesis.synthesis_lib_tags import SynthesisLibTags
...
class SynthesizeDijTags():

    def __init__(self):

        self.model = Model()
        self.synthesis_lib_tags = SynthesisLibTags("localhost", "8181", self.model)
    ...
    def push_switch_changes(self):
        self.synthesis_lib_tags.trigger(self.s)

def main():
    sm = SynthesizeDijTags()
