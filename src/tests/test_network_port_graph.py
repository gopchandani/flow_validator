...
class TestNetworkPortGraph(unittest.TestCase):
    ...
    def match_admitted_traffic(self, ng, npg, src_host_obj, dst_host_obj, specific_traffic):

        at = get_admitted_traffic(npg, src_host_obj.switch_port, dst_host_obj.switch_port)
        self.assertEqual(specific_traffic.is_equal_traffic(at), True)
    ...
    def test_admitted_traffic_linear_dijkstra_new_mode_init(self):
        ...
        # Same switch
        at = self.check_admitted_traffic(self.ng_linear_dijkstra_mac_acl, self.npg_linear_dijkstra_new_mode_init_mac_acl,
                                         h1s1, h2s1)
        # Different switch
        at = self.check_admitted_traffic(self.ng_linear_dijkstra_mac_acl, self.npg_linear_dijkstra_new_mode_init_mac_acl,
                                         h1s1, h1s2)
        ...
        at_to_match = Traffic()
        self.match_admitted_traffic(self.ng_linear_dijkstra_mac_acl, self.npg_linear_dijkstra_new_mode_init_mac_acl,
                                    h1s1, h2s2, at_to_match)

        self.match_admitted_traffic(self.ng_linear_dijkstra_mac_acl, self.npg_linear_dijkstra_new_mode_init_mac_acl,
                                    h2s1, h1s2, at_to_match)
    ...
    #
    #     # Same switch
    #     at = self.check_admitted_traffic(self.ng_linear_dijkstra, self.npg_linear_dijkstra_new_mode_init,
    #                                      h1s1, h2s1)
    #
    #     # Different switch
    #     at = self.check_admitted_traffic(self.ng_linear_dijkstra, self.npg_linear_dijkstra_new_mode_init,
