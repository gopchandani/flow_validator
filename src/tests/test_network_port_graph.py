...
class TestNetworkPortGraph(unittest.TestCase):
    ...
    def test_admitted_traffic_linear_dijkstra(self):
        ...
        # Same switch
        at = self.check_admitted_traffic(self.ng_linear_dijkstra, self.npg_linear_dijkstra,
                                         h1s1, h2s1)
    ...
    def test_admitted_traffic_ring_aborescene_apply_true(self):
        ...
        at = self.check_admitted_traffic(self.ng_ring_aborescene_apply_true, self.npg_ring_aborescene_apply_true,
                                         h11, h31)
